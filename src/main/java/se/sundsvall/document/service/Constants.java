...
public final class Constants {
	...
	public static final String TEMPLATE_EVENTLOG_MESSAGE_CONFIDENTIALITY_UPDATED_ON_FILE = "Confidentiality flag updated to: '%s' with legal citation: '%s' for document with registrationNumber: '%s' and file with name: '%s'. Action performed by: '%s'";
